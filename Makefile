...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/12/07 15:08:51 by ldalle-a          #+#    #+#              #
#    Updated: 2021/12/07 15:08:54 by ldalle-a         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC				= 	gcc
FLAGS           =  -Wall -Wextra -Werror -ltermcap -lreadline -g -fsanitize=address -I ./homebrew/Cellar/readline/8.1.1/include -L ./homebrew/Cellar/readline/8.1.1/lib
RM				= 	rm -f
LIBFLAGS 		= 	-I ./libft -L ./libft -L . ./libft/*.c 
HOMEBREW		= 	homebrew/opt/readline/lib

all:			 $(HOMEBREW) ${NAME} libft_all
